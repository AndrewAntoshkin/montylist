...
export function formatCharactersForPromptV4(
  ...
  const lines: string[] = [
    ...
    '2. ВАЖНО: В заставке показаны титры с именами актёров и персонажей — запомни их!',
    '   - Титр "Тома - Елена Доронина" = персонаж ТОМА',
    '   - Используй эти имена когда видишь этих актёров позже в фильме',
    '3. Если у персонажа есть описание — сравни с тем, что видишь в кадре.',
    '4. Если описания нет — смотри кого называют по имени в диалогах.',
    '5. НЕ пиши роль (Косметолог, Официант) — всегда ищи имя!',
    '6. За кадром — добавь ЗК (например: ИМЯ ЗК)',
    '',
