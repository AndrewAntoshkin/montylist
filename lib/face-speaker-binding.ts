...
export function calibrateSpeakersByNameMentions(
  ...
  // Универсальные роли, которые могут упоминаться в любом фильме
  const COMMON_ROLES = [
    'менеджер', 'директор', 'начальник', 'босс', 'шеф',
    'доктор', 'врач', 'медсестра', 'медбрат',
    'учитель', 'преподаватель', 'профессор',
    'полицейский', 'милиционер', 'следователь',
    'адвокат', 'юрист', 'судья',
